...
#pragma config(Motor,  port8,           RightFront,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port9,           RightTower,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port10,          LeftTower,     tmotorVex393HighSpeed_HBridge, openLoop, reversed)
